    ...
    def _build_prompt(
        ...
        *,
        ...
        user_prompt = (
            ...
            "2b. NUMERIC PACING: never replace an exact number, unit, ratio, or measurement "
            "with a vague word. For Vietnamese and other supported targets, prefer compact "
            "Arabic-digit notation (for example `1.200`, `1,4 m`, `1:1`) when the spoken "
            "line is short; the text normalizer will expand it for pronunciation. Keep the "
            "same value and unit, and do not write a long number phrase if it would overflow "
            "the trusted duration.\n"
