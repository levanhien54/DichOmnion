...
// .wrangler/tmp/bundle-n27dau/checked-fetch.js
...
// .wrangler/tmp/bundle-n27dau/strip-cf-connecting-ip-header.js
...
app.use("/api/*", cors({
  origin: "*",
  // Trong production nên giới hạn origin
...
app.post("/api/auth/register", async (c) => {
  try {
    ...
    await c.env.KV_CACHE.put(deviceId, JSON.stringify(body.publicKeyJwk));
...
app.post("/api/jobs/create", async (c) => {
  ...
  const publicKeyJwk = await c.env.KV_CACHE.get(deviceId, { type: "json" });
  if (!publicKeyJwk) {
...
// .wrangler/tmp/bundle-n27dau/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-n27dau/middleware-loader.entry.ts
